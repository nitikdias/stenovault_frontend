...
export default function File() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      const res = await fetch('https://1ecb-103-50-21-208.ngrok-free.app/upload', {
        method: 'POST',
        body: formData,
      });
  ...
  try {
    const res = await fetch('https://1ecb-103-50-21-208.ngrok-free.app/process', { method: 'POST' });
  ...
  try {
    ...
    const res = await fetch('https://1ecb-103-50-21-208.ngrok-free.app/clear', { method: 'POST' });
    if (res.ok) {
