...
export default function File() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      const res = await fetch('https://304d-2409-40f2-2019-40-c8ff-a288-d742-2363.ngrok-free.app/upload', {
        method: 'POST',
        body: formData,
      });
  ...
  try {
    const res = await fetch('https://304d-2409-40f2-2019-40-c8ff-a288-d742-2363.ngrok-free.app/process', { method: 'POST' });
  ...
  try {
    ...
    const res = await fetch('https://304d-2409-40f2-2019-40-c8ff-a288-d742-2363.ngrok-free.app/clear', { method: 'POST' });
    if (res.ok) {
